    ...
    for t in range(0,len(new_coeffs_array)):
        ...
        out = optimize.least_squares(errfunc_coeffs, pinit, bounds=bounds_array,
                       args=(df_choice["EW_Balmer"], df_choice["FeH"],
                             df_choice["EW_CaIIK"], df_choice["err_EW_CaIIK"]))
        ...
        plt.errorbar(df_choice["EW_Balmer"], df_choice["EW_CaIIK"], yerr=df_choice["err_EW_CaIIK"], marker="o", markerfacecolor="orange", ecolor="k", ls="none", label="Empirical")

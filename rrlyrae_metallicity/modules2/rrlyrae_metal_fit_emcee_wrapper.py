...
# fix some values
Teff = 0.0586758 # from previous IDL runs (deprecated, I think)
...
'''
# plot one variable (note if saving progressively, this just saves the last iteration)
#print(np.shape(sampler.flatchain[:,-1]))
